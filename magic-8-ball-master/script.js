$(document).ready(function() {
  ...
  /* 
    ...
    1c. Which data type is being stored as the value in your variables? Answer here: a string
  ...
  */
    ...
    let answer2 = "no";
    let answer3 = "maybe";
    let answer4 = "most likely";
    

  magic8Ball.listOfAnswers = [answer1,answer2,answer3,answer4]
  $("#answer").hide();
  ...
  /* 
    ...
    2c. Whoaaaa... why did that happen?
        Answer: It determines how quickly the answer pops up
  ...
  */
    ...
    /*
      ...
      3b. What happened?
          Answer: It made it so that it always says yes because that it the first one in the string.



      3c. Try putting 1. What happened then?
          Answer: It made it so that it always says no becuase that is the second one in the string.
      ...
      3d. If you hadn't already explained above, why did the things that happened for 3b and 3c happen? If you already
          ...
          Answer: Why did the char cross the rode, becuase she is good at coding.
  ...
  5a. Please write what your magic 8 ball contents should be now that there's been some additions to it.
      ...
      magic8Ball = {
        ...
        askQuestions: function(question),
  ...
  */
  ...
  var onClick = function() {
    ...
    */
    $("#8ball").attr("src", "https://art.pixilart.com/sr2712ab0b35ecd.gif");
